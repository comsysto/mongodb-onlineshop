...
/**
 * this is a clone because I had to add the possibility of using MongoURI instead of regular parameters!
 */
...
public final class MongoDBDataModel implements DataModel {
    ...
    public MongoDBDataModel(MongoURI uri,
                            String database,
                            String collection,
                            boolean manage,
                            boolean finalRemove,
